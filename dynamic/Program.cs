...
namespace dynamic
{
    class Program
    {
        public static void OldWay(string[,] data, string savePath)
        {
            ...
            workSheet.SaveAs(savePath + "\\shpark-book-old_1.xlsx",
                Type.Missing,
                Type.Missing,
                Type.Missing,
                Type.Missing,
        ...
        public static void NewWay(string[,] data, string savePath)
        {
            ...
            for (int i = 0; i < data.GetLength(0); i++)
            {
                ...
                workSheet.Cells[i + 1, 3] = "test";
                workSheet.Cells[i + 1, 4] = "test2";
            }

            workSheet.SaveAs(savePath + "\\shpark-book-dynamic_1.xlsx");
            excelApp.Quit();
        }
